...
public:
	...
	void drawGraphGeometry(Shader* shaderToUse, vec3 positionOffset, vec3 scaleOffset)
	{
		glBindVertexArray(VAO);
		shaderToUse->use();
		shaderToUse->processTransformations(positionOffset, scaleOffset);
	...
	void drawGraphGeometry(Shader* shaderToUse, vec3 positionOffset, vec3 scaleOffset, float rotationOffset, vec3 rotationAxis)
	{
		glBindVertexArray(VAO);
		shaderToUse->use();
		shaderToUse->processTransformations(positionOffset, scaleOffset, rotationOffset, rotationAxis);
